        ...
        messages: [
          {
            ...
            5. Описание в свободной форме 1-2 предложения. Для одежды о наличии принтов, типа стиля, кроя и т.д. Для обуви опиши дизайн (например, классический, спортивный, ботильоны, кроссовки и т.д.). Для штанов укажите покрой (например, прямые, зауженные, клеш)
